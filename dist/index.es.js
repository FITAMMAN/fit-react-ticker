...
var FinancialTicker = function (props) {
    ...
    return (React.createElement("div", { "data-id": props.id, className: [styles.tickerItem, stylesFinancial.tickerItemFinancial].join(' ') },
        React.createElement("div", { className: stylesFinancial.tickerTopLevel },
            React.createElement("div", { className: stylesFinancial.tickerSymbol }, props.symbol),
            React.createElement("div", { className: stylesFinancial.lastPrice }, props.lastPrice)),
        React.createElement("div", { className: stylesFinancial.tickerStats },
            React.createElement("img", { width: '20px', height: '20px', className: stylesFinancial.tickerMovement, src: Number(props.currentPrice) === 0 ? chevronZero : (props.change ? chevronUp : chevronDown) }),
            "      ",
            React.createElement("div", { className: [statusClassName, stylesFinancial.tickerInfo].join(' ') },
                React.createElement("div", { className: stylesFinancial.tickerChangePercentage }, props.percentage),
                React.createElement("div", { className: stylesFinancial.tickerCurrentPrice }, props.currentPrice)))));
};
...
var NewsTicker = function (props) {
    return (React.createElement("a", { className: [newsStyles.newsticker, styles.tickerItem].join(' '), href: props.url, target: "_blank" },
        React.createElement("div", { className: newsStyles.icon },
            React.createElement("img", { src: props.icon, alt: props.iconAlt })),
        React.createElement("div", { className: newsStyles.newsWrapper },
            React.createElement("div", { className: newsStyles.title }, props.title),
            React.createElement("small", { className: newsStyles.meta }, props.meta))));
};

var TickerList = function (props) {
    return React.createElement("div", { className: styles.ticker },
        React.createElement("div", { className: styles['ticker-list'] }, props.children),
        !props.isNewsTicker ?
            React.createElement("div", { className: styles['ticker-list'] }, props.children)
            : '');
};

export { FinancialTicker, NewsTicker, TickerList as default };
